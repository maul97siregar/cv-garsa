...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('icons/logo_cv.png') }}"/> <!-- title icon -->
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}">
            <img src="{{ asset('icons/logo_cv.png') }}" alt="logo" /> </a>
        ...
        <div class="main-panel">
          ...
          <footer class="footer" id="footer-content">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">©<a href="http://www.bootstrapdash.com/" target="_blank">Meisya Resti Garsari</a>. Point of Sale</span>
