            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Lengkap" value="{{$data->alamat}}" required>
                        @error('alamat')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="kontak" name="kontak" placeholder="Nomor Handphone" value="{{$data->kontak}}" required>
                        @error('kontak')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="posisi" name="jabatan_id" required>
                          <option value="{{$data->jabatan_id}}">-- {{$data->nama_jabatan}} --</option>
