            ...
            <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="no_pegawai" name="no_pegawai" value="{{$pegawai}}" readonly>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="tgl_mulai" name="tgl_mulai" value="{{$tgl_mulai}}" readonly>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="tgl_selesai" name="tgl_selesai" value="{{$tgl_selesai}}" readonly>
                  </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="total_absen" name="total_absen" value="" onkeyup="sum();">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="total_korosok" name="total_korosok" value="" onkeyup="sum();"> 
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="total_pk20" name="total_pk20" value="" onkeyup="sum();">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="total_pk40" name="total_pk40" value="" onkeyup="sum();">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="total_pkk20" name="total_pkk20" value="" onkeyup="sum();">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="total_pkk40" name="total_pkk40" value="" onkeyup="sum();">
                    </div>
                </div>
            </div>
