            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="no_pegawai" name="no_pegawai" required>
                          <option value="{{$data->no_pegawai}}">-- {{$data->no_pegawai}} --</option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tgl_peminjaman" name="tgl_peminjaman" placeholder="Tanggal Pinjam" value="{{$data->tgl_peminjaman}}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Jumlah Peminjaman" min="0" value="{{$data->jumlah}}" required>
                        @error('jumlah')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
